...
namespace FakturyMVC.Controllers
{
    ...
    public sealed class InvoiceDAL
    {
        ...
        public List<InvoiceGenerals> InvoiceSearch
        (
            string number = null,
    ...
    /*public class InvoiceDAL
    {
        ...
        static InvoiceDAL()
        {
            ...
            _connectionString = ConfigurationManager.ConnectionStrings[System.Environment.MachineName.ToUpper()].ConnectionString;
        }

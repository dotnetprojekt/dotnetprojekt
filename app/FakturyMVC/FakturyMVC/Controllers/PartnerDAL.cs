...
namespace FakturyMVC.Controllers
{
    ...
    public sealed class PartnerDAL
    {
        ...
        public List<Partner> PartnerList(int pageNumber = 1, int rowsPerPage = Int32.MaxValue)
        {
        ...
        public List<Partner> PartnerSearch(string firstName = null, string lastName = null, string companyName = null, long vatin = -1, int pageNumber = 1, int rowsPerPage = Int32.MaxValue)
        {
